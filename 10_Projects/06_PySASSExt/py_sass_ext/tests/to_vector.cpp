...
int main()
{
    ...
    using Test_Type11_0 = std::tuple<TOptions>;
    using Test_Type11 = std::variant<Test_Type11_0>;
    ...
    Test_Type11 t11_0 = Test_Type11_0{o};
    ...
    Test_Type11 res11_0 = Pickle::loads<Test_Type11>(v11_0);
