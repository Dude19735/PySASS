...
with open('clean.history', 'w') as log_file:
    ...
    document_sass_location = location + "/DocumentSASS"
    kbin_location = location + "/kbin"
    ...
    all_hex_files = get_X_files(locations, lambda x: x.endswith(".hex"))
    ...
    remove_X_files(out, all_hex_files, start_stmt=PREF + "Remove [*.hex] files...")
