...
class BInstr_B(BInstrBase):
    """This one tests the DMUL instruction with barriers.
    ...
    def __init__(self, kk_sm:KK_SM, props:KernelWLoopControlProps):
        ...
        main = sc.SASS_KK__dmul__RRR_RR(kk_sm,
...
class Benchmark(BenchmarkBase):
    def __init__(self, sm_nr:int, experiment_nr:int=0):
        super().__init__(sm_nr, 
                         name='dmul',
                         purpose="\n".join([
                            "These benchmarks test DMUL with and without barrier.",
                            "* With barrier it takes 49 cycles",
                            "* Without barrier it takes 42 cycles",
                            "",
                            "Exactly the same as FADD and DADD.",
                            "DMUL blocks for 34 to 35 cycles, no matter what.",
                            "",
...
if __name__ == '__main__':
    # This one has to be ported
    b = Benchmark(75, experiment_nr=1)
    print("Finished")
    pass
