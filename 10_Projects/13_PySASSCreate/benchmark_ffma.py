...
class BInstr___ffma__RRR_RRR___WAITX(BInstrBase):
    ...
    def __init__(self, kk_sm:KK_SM, props:KernelWLoopControlProps, wait_cycles:int):
        ...
        f32_36 = sc.SASS_KK__i2f__IU_32b(kk_sm, Pg_negate=False, Pg=PT, Rd=R36, Sb=20, dst_format=32, usched_info_reg=wait15, wr=0x0, rd=0x7)
        ...
        self.add_pre_clock_prequels(f32_36.class_name, f32_36.enc_vals)
        ...
        main = sc.SASS_KK__ffma__RRR_RRR(kk_sm,
                           Pg_negate=False, Pg=PT, Rd=R30,
                           Ra_reuse=False, Ra_absolute=False, Ra_negate=False, Ra=R32,
                           Rb_reuse=False, Rb_absolute=False, Rb_negate=False, Rb=R34,
                           Rc_reuse=False, Rc_absolute=False, Rc_negate=False, Rc=R36,
        ...
        # move_result = sc.SASS_KK__STG_RaRZ(kk_sm,
        #                            uniform_reg=props.ui_output_base_ureg, offset=0x0, 
        #                            source_reg=R30, 
        #                            usched_info_reg=wait15,
        #                            rd=0x0)

class BenchmarkFFMA(BenchmarkBase):
    def __init__(self, sm_nr:int, experiment_nr:int=0):
        super().__init__(sm_nr, 
                         name='ffma',
                         purpose="\n".join([
                            "This benchmark tests FFMA and measures how many cycles are required.",
                            "",
                            "FFMA is a fixed latency instruction. It requires 5 cycles."]),
        ...
        if experiment_nr in (0,1):
            ...
            offset = 1
            bInstrList = [BInstr___ffma__RRR_RRR___WAITX(self.kk_sm, props, w) for w in range(offset, 10)]
            # bInstrList = [BInstr___ffma__RRR_RRR___WAITX(self.kk_sm, props, 15)]
            exe_name_stem = '{0}/{1}'.format(self.modified_location, 'ffma')
